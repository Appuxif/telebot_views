    ...
    async def message_handler(msg: Message):
        ...
        try:
            ...
            if msg.business_connection_id and msg.business_connection_id != business_connection_id:
                con: BusinessConnection = await with_cache(
                    f'get_business_connection:{msg.business_connection_id}', 3600
                )(bot.bot.get_business_connection)(msg.business_connection_id)
                logger.warning(
